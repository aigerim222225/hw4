...
class WGraph<T> {//Weighted Graph
    ...
    public static class Main {
        ...
        public static void main(String[] args) {
            WGraph<String> graph = new WGraph<>(true);

            graph.insertEdge("Almaty", "Astana", 2.1);
            graph.insertEdge("Almaty", "Shymkent", 7.2);
            graph.insertEdge("Shymkent", "Astana", 3.9);
            graph.insertEdge("Astana", "Kostanay", 3.5);
            graph.insertEdge("Shymkent", "Kyzylorda", 5.4);
...
//        outputPath(bfs, "Kyzylorda");
        ...
        public static void outputPath(Search<String> search, String key) {
            for (Vertex<String> v : search.pathToVertex(key)) {
                System.out.print(v + " -> ");
            }
        }
    }}
